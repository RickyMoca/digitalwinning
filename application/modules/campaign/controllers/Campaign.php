...
class Campaign extends MY_Controller
{
	...
	public function index()
	{
		$data = [
			'title' => 'Campaign',
			'page_name' => 'Campaign',
			'id' => $this->M_campaign->get_autonumber(),
			'getrole' => $this->M_campaign->get_role(),
			'getuser' => $this->M_campaign->get_user()
		];
		load_template('v_campaign', $data);
		destroy_flashdata();
	}
